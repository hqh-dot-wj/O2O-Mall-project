...
- **apps/backend/docs/**：**约 97 个文档**，含大量 REFACTORING*\*、OPTIMIZATION*_、COMMISSION\__、COUPON\_\* 等，部分描述“ResultData 已迁移为 Result”，但 **utils/result.ts 仍存在且 OpenAPI 仍用 ResultData**。
