...
export class DistributionController {
  ...
  async getCommissionPreview(@Query('tenantId') tenantId: string, @Query('shareUserId') shareUserId?: string) {
    return this.distributionService.getCommissionPreview(tenantId, shareUserId);
  }
}
