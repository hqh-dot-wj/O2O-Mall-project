...
6. **数据能力不足**：缺少财务报表，运营决策缺少数据支撑
7. **风控能力不足**：缺少风险监控、实名认证，合规性不足
...
**建设 P1 级模块**，增强营销能力、风控能力、数据能力：

1. **积分账户**（2-3 周）：支持积分营销，提升用户粘性
2. **优惠券账户**（2-3 周）：与 marketing 模块集成，完善营销能力
3. **财务报表**（3-4 周）：提供运营决策数据支撑
4. **风险监控**（3-4 周）：监控异常交易，防止资金损失
5. **实名认证**（2-3 周）：提升合规性
6. **审计日志增强**（1-2 周）：完善审计能力
