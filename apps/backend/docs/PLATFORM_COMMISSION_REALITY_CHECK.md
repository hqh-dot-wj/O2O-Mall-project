...
- [平台抽成指南](apps/backend/docs/PLATFORM_COMMISSION_GUIDE.md) - 概念和设计
- [端到端测试指南](apps/backend/docs/E2E_TEST_GUIDE.md) - 测试说明
- [完整业务流程](apps/backend/docs/COMPLETE_BUSINESS_FLOW.md) - 业务流程
