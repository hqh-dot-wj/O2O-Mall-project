...
> **事实来源**：本索引与代码/OpenAPI 的核对日期 **2026-02-10**。
...
- **[e2e-tests/](./e2e-tests/)** - 端到端测试文档
  ...
  - [实现记录](./e2e-tests/E2E_TEST_IMPLEMENTATION.md)
...
- **[code_PR.md](./code_PR.md)** - 接口与大表设计规范（PR 必读）
...
- 2026-02-21: 精简文档结构，删除 archive/、TODO/、冗余与一次性报告
