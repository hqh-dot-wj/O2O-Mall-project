...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'http://localhost:8080/api'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'http://localhost:8080/api'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'http://localhost:8080/api'
