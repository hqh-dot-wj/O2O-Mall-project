const local: App.I18n.Schema = {
  ...
  route: {
    ...
    store_marketing_activity: 'Activity Config',
    'store_marketing_coupon-distribution': 'Coupon Distribution',
    'store_marketing_coupon-usage': 'Coupon Usage',
    store_marketing_distribution: 'Distribution Config',
    'store_marketing_distribution-application': 'Distribution Application',
    'store_marketing_distribution-dashboard': 'Distribution Dashboard',
    'store_marketing_distribution-level': 'Distribution Level',
    marketing: 'Marketing',
