const local: App.I18n.Schema = {
  ...
  route: {
    ...
    exception_500: '500',
    store: 'Store',
    store_finance: 'Finance',
    store_finance_dashboard: 'Dashboard',
    store_finance_commission: 'Commission',
    store_finance_withdrawal: 'Withdrawal',
    store_finance_ledger: 'Ledger',
    ...
    store_distribution_distribution: 'Distribution Config',
    'store_distribution_distribution-application': 'Distribution Application',
    'store_distribution_distribution-dashboard': 'Distribution Dashboard',
    'store_distribution_distribution-level': 'Distribution Level',
    'store_distribution_distribution-product': 'Distribution Product',
    store_product: 'Products',
    store_product_list: 'Product List',
    store_product_market: 'Market',
    store_stock: 'Stock',
    marketing: 'Marketing',
