const local: App.I18n.Schema = {
  ...
  route: {
    ...
    exception_404: '404',
    exception_500: '500',
    store_marketing: '营销活动',
    store_marketing_activity: '营销活动配置',
    'store_marketing_coupon-distribution': '优惠券发放',
    'store_marketing_coupon-usage': '优惠券使用',
    store_marketing_distribution: '分销规则配置',
    'store_marketing_distribution-application': '分销申请',
    'store_marketing_distribution-dashboard': '分销看板',
    'store_marketing_distribution-level': '分销等级',
    // 订单中心
    order: '订单中心',
    order_list: '订单列表',
    order_detail: '订单详情',
