const local: App.I18n.Schema = {
  ...
  route: {
    ...
    store_distribution_distribution: '分销规则配置',
    'store_distribution_distribution-application': '分销申请',
    'store_distribution_distribution-dashboard': '分销看板',
    'store_distribution_distribution-level': '分销等级',
    'store_distribution_distribution-product': '分销商品',
    store_product: '门店商品',
    store_product_list: '商品列表',
    store_product_market: '选品中心',
    store_stock: '库存管理',
    // 营销中心
    marketing: '营销中心',
