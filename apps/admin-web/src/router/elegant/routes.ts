    ...
    children: [
      {
        ...
        children: [
          ...
          {
            name: 'store_marketing_distribution-application',
            path: '/store/marketing/distribution-application',
            component: 'view.store_marketing_distribution-application',
            meta: {
              title: 'store_marketing_distribution-application',
              i18nKey: 'route.store_marketing_distribution-application'
            }
          },
          {
            name: 'store_marketing_distribution-dashboard',
            path: '/store/marketing/distribution-dashboard',
            component: 'view.store_marketing_distribution-dashboard',
            meta: {
              title: 'store_marketing_distribution-dashboard',
              i18nKey: 'route.store_marketing_distribution-dashboard'
            }
          },
          {
            name: 'store_marketing_distribution-level',
            path: '/store/marketing/distribution-level',
            component: 'view.store_marketing_distribution-level',
            meta: {
              title: 'store_marketing_distribution-level',
              i18nKey: 'route.store_marketing_distribution-level'
            }
          },
          {
            name: 'store_marketing_distribution-product',
            path: '/store/marketing/distribution-product',
            component: 'view.store_marketing_distribution-product',
            meta: {
              title: 'store_marketing_distribution-product',
              i18nKey: 'route.store_marketing_distribution-product'
            }
          }
        ]
      },
