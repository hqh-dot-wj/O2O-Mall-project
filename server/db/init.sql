/*
 ...
 Source Schema         : nest-admin-soybean
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (100, 0, '0', 'nest-admin-soybean科技', 0, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (101, 100, '0,100', '深圳总公司', 1, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (102, 100, '0,100', '长沙分公司', 2, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (103, 101, '0,100,101', '研发部门', 1, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (104, 101, '0,100,101', '市场部门', 2, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (105, 101, '0,100,101', '测试部门', 3, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (106, 101, '0,100,101', '财务部门', 4, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (107, 101, '0,100,101', '运维部门', 5, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (108, 102, '0,100,102', '市场部门', 1, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (109, 102, '0,100,102', '财务部门', 2, 'nest-admin-soybean', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, NULL);
COMMIT;
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`) VALUES (4, 'nest-admin-soybean官网', 0, 4, 'https://nest-admin.dooring.vip', NULL, '', '0', '0', 'M', '0', '0', '', 'guide', 'admin', '2025-02-28 16:52:10.000000', '', NULL, 'nest-admin-soybean官网地址', '0');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_notice` (`notice_id`, `notice_title`, `notice_type`, `notice_content`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (1, '温馨提醒：2018-07-01 nest-admin-soybean新版本发布啦', '2', '新版本内容', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, '0', NULL);
INSERT INTO `sys_notice` (`notice_id`, `notice_title`, `notice_type`, `notice_content`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (2, '维护通知：2018-07-01 nest-admin-soybean系统凌晨维护', '1', '维护内容', '0', 'admin', '2025-02-28 16:52:10.000000', '', NULL, '0', NULL);
COMMIT;
